  ...
  return (
    <div className="relative flex h-full min-h-0">
      <button
        ...
        className="absolute right-3 top-3 z-20 hidden h-8 w-8 items-center justify-center rounded border border-zinc-300 bg-white text-zinc-600 shadow-sm transition hover:text-zinc-900 lg:inline-flex"
      ...
      >
        ...
        >
          ...
          <path d="M14 4.5v15" />
          {isAiSidebarOpen ? (
            <path d="M9.5 12h-3m0 0l1.4-1.4M6.5 12l1.4 1.4" />
          ) : (
            <path d="M8.5 12h3m0 0l-1.4-1.4M11.5 12l-1.4 1.4" />
          )}
        </svg>
      </button>
      <div className="scrollbar-minimal min-w-0 flex-1 overflow-y-auto">
